...
CREATE TABLE properties (
    ...
    property_type propertytype NOT NULL DEFAULT 'flatApartment',
    lat FLOAT,
    lng FLOAT,
...
CREATE INDEX idx_properties_owner ON properties(property_owner_id);  -- For owner-based queries
...
INSERT INTO properties (address, city, area, property_type, lat, lng, property_owner_id) VALUES
('123 Sample Street, Koramangala 5th Block', 'Bengaluru', 'Koramangala', 'flatApartment', 12.9352, 77.6245, 2),
('456 Test Road, Indiranagar 2nd Stage', 'Bengaluru', 'Indiranagar', 'villaHouse', 12.9719, 77.6412, 2),
('789 Demo Layout, HSR Layout Sector 1', 'Bengaluru', 'HSR Layout', 'pgHostel', 12.9116, 77.6497, 2);
