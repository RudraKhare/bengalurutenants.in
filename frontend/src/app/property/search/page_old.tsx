...
export default function PropertySearchPage() {
  ...
  const initialPropertyType = searchParams.get('propertyType') || ''; // Changed to empty string - no default selection
  ...
  const [viewMode, setViewMode] = useState<'list' | 'map' | 'split'>('split'); // New state for view mode
  const [selectedPropertyId, setSelectedPropertyId] = useState<number | null>(null); // Track selected property
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Page header with extended search */}
      ...
      <div className="flex gap-4 px-4">
        ...
        <div className="w-1/2">
          {loading ? ( className="mt-2 text-xs text-gray-500">
        ...
        {/* Main Content - Property Listings and/or Map */}
