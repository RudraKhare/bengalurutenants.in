  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      if (propertiesResponse.ok) {
        ...
        console.error('Failed to fetch properties:', propertiesResponse.statusText);
      }
    } catch (err) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <Link
          href="/review/add"
          className="bg-primary-600 hover:bg-primary-700 text-white p-6 rounded-lg transition-colors"
        >
          <h3 className="text-lg font-semibold mb-2">Add New Review</h3>
          <p className="text-primary-100">Share your rental experience</p>
        </Link>
